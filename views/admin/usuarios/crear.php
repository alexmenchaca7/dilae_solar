...
<div class="dashboard__formulario">
    ...
    <?php if(isset($_GET['confirmacion']) && $_GET['confirmacion'] == 1): ?>
        <p class="alerta alerta__exito">Usuario registrado correctamente. Revisa tu email para confirmar tu cuenta</p>
    <?php endif; ?>

    <form method="POST" action="/admin/usuarios/crear" class="formulario">
